...
abstract class QodeFrameworkSection implements iQodeFrameworkTreeInterface, iQodeFrameworkChildInterface {
	private $scope;
	private $type;
	private $name;
	private $layout;
	...
	function render() {
		...
		qode_framework_template_part( QODE_FRAMEWORK_INC_PATH, 'common', 'templates/section', $this->get_layout(), $params );
	}
}