<?php
class QodeFrameworkPageMeta extends QodeFrameworkPage {
	...
	function add_tab_element( $params ) {
		if ( isset( $params['name'] ) && ! empty( $params['name'] ) ) {
			...
			$field = new QodeFrameworkTabMeta( $params );
	...
	function add_repeater_element( $params ) {
		...
		qode_framework_get_framework_root()->get_meta_options()->set_option( $params['name'], '', 'repeater' );
