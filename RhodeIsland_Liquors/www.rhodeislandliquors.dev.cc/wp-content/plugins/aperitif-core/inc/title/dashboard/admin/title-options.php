...
if ( ! function_exists( 'aperitif_core_add_page_title_options' ) ) {
	/**
	 * Function that add general options for this module
	 */
	function aperitif_core_add_page_title_options() {
		...
		$page = $qode_framework->add_options_page(
			array(
				...
				'description' => esc_html__( 'Global settings related to title', 'aperitif-core' )
			)
		);
		...
		if ( $page ) {
			...
			$page_title_section->add_field_element(
				array(
					...
					'options'       => apply_filters( 'aperitif_core_filter_title_layout_options', array() ),
					'default_value' => 'standard-with-breadcrumbs'
				)
			);
			...
			do_action( 'aperitif_core_action_after_page_title_options_map', $page_title_section );
		}
	}
	
	add_action( 'aperitif_core_action_default_options_init', 'aperitif_core_add_page_title_options', aperitif_core_get_admin_options_map_position( 'title' ) );
}