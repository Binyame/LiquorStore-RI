...
if ( ! function_exists( 'aperitif_core_add_elegant_icons_to_collection' ) ) {
	function aperitif_core_add_elegant_icons_to_collection( $icons ) {
		$icons[] = 'AperitifCoreElegantIconsPack';
		
		return $icons;
	}
	
	add_filter( 'qode_framework_filter_add_icon', 'aperitif_core_add_elegant_icons_to_collection' );
}

if ( class_exists( 'QodeFrameworkIconPack' ) ) {
	class AperitifCoreElegantIconsPack extends QodeFrameworkIconPack {
		...
		public function add_icon_pack() {
			$this->set_base( 'elegant-icons' );
			$this->set_name( 'Elegant Icons' );
		...
		function specific_icons() {
			return array(
				'search'        => 'icon_search',
				'dropdown-cart' => 'icon_cart',
				'menu'          => 'icon_menu',
				'close'         => 'icon_close',
				'back-to-top'   => 'arrow_carrot-up',
				'mobile-menu'   => 'icon_menu',
				'quote'         => 'icon_quotations',
