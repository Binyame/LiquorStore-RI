...
if ( ! function_exists( 'aperitif_core_add_material_icons_to_collection' ) ) {
	function aperitif_core_add_material_icons_to_collection( $icons ) {
		$icons[] = 'AperitifCoreMaterialIconsPack';
		
		return $icons;
	}
	
	add_filter( 'qode_framework_filter_add_icon', 'aperitif_core_add_material_icons_to_collection' );
}

if ( class_exists( 'QodeFrameworkIconPack' ) ) {
	class AperitifCoreMaterialIconsPack extends QodeFrameworkIconPack {
		...
		public function add_icon_pack() {
			$this->set_base( 'material-icons' );
			$this->set_name( 'Material Icons' );
		...
		public function render_html( $icon_class, $icon_attributes_string, $icon ) {
			$icon_class[] = $this->get_base();
			
			return '<span class="' . implode( ' ', $icon_class ) . '" ' . $icon_attributes_string . '>' . $icon . '</span>';
		}
	}
}