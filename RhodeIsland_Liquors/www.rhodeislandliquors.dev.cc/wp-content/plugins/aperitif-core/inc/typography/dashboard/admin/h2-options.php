...
if ( ! function_exists( 'aperitif_core_add_h2_typography_options' ) ) {
	/**
	 * Function that add general options for this module
	 */
	function aperitif_core_add_h2_typography_options( $page ) {
		...
		if ( $page ) {
			$h2_tab = $page->add_tab_element(
				array(
					'name'        => 'tab-h2',
					'icon'        => 'fa fa-cog',
					'title'       => esc_html__( 'H2 Typography', 'aperitif-core' ),
					'description' => esc_html__( 'Set values for Heading 2 html element', 'aperitif-core' )
				)
			);
	...
	add_action( 'aperitif_core_action_after_typography_options_map', 'aperitif_core_add_h2_typography_options' );
}