<article <?php post_class( 'qodef-blog-item qodef-e' ); ?>>
	<div class="qodef-e-inner">
		<?php
		// Include post media
		aperitif_template_part( 'blog', 'templates/parts/post-info/media' );
		?>
		<div class="qodef-e-content">
			...
			<div class="qodef-e-text">
				<?php
				// Include post title
				aperitif_template_part( 'blog', 'templates/parts/post-info/title' );
				
				// Include post excerpt
				aperitif_template_part( 'blog', 'templates/parts/post-info/excerpt' );
